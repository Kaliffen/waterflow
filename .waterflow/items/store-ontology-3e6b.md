...
for that unverified set on its own, which is the list of what the subject would
have to prove to be sure of itself. A target nobody has measured is reported as
